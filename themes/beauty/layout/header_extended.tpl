<noscript>
    ...
    <header class="header sticker" data-lazyload2="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/bg-menu.jpg" style='background-image: url("{NV_BASE_SITEURL}themes/{TEMPLATE}/images/loading.svg");background-color: #2e476d;'>
      <div class="wraper">   
